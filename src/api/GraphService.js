...
const apiClient = axios.create({
  ...
  : `${import.meta.env.VITE_BACKEND_URL}/graph`,
...
export const getGraphDataService = async () => {
    try{
      const graphResponse = await apiClient.get('/all');
      return await graphResponse.data;
    }catch(error){
        if (error.response){
